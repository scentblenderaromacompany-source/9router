...
export class MiniMaxWebExecutor extends WebUIExecutor {
  ...
  async buildWebPayload(model, messages, stream, credentials) {
    ...
    // Preserve tools: native MCP format or client-provided tools
  ...
  /**
   * Parse tool calls from MiniMax model output.
   * MiniMax uses bracket protocol for managed tool calling.
