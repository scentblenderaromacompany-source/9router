 ...
 * Ported from Chat2API services/promptGenerator.ts
 */
 ...
 */
function generatePerplexityPrompt(tools) {
  const toolDefinitions = generateToolDefinitions(tools)
...
class PromptGenerator {
  ...
  /**
   * Generate tool definitions only
   */
  static generateToolDefinitions(tools) {
   ...
   * Generate tool names list
   */
  static generateToolNames(tools) {
   ...
   */
  static getFormatExample(format) {
 ...
 */
function generateToolPrompt(tools, format = 'bracket') {
