/**
 * Tool choice policy normalization
 * Ported from Chat2API toolChoicePolicy.ts
 */

class ToolChoicePolicyError extends Error {
...
function normalizeToolChoicePolicy(toolChoice, tools) {
...
export { ToolChoicePolicyError, normalizeToolChoicePolicy }
